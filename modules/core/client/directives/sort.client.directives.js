(function() {
    ...
    function Sort() {
        return {
            ...
            transclude: true,
            template:
            '<span ng-click="onClick()" ng-class="{\'desc\':$root.selectItemGroup[target] === order&&$root.reverseGroup[target], \'asc\': $root.selectItemGroup[target] === order&&!$root.reverseGroup[target]}" class="sorting">' +
